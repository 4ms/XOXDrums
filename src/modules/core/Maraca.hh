...
public:
	...
	float highpass(float input, float& prevInput1, float& prevInput2, float& prevOutput1, float& prevOutput2, float cutoffFreq, float sampleRate1, float resonance) {
	...
	void update(void) override {
		...
		highpassOut = highpass(VCAOut, prevIn1, prevIn2, prevOut1, prevOut2, hpCutoffFreq, sampleRate, highpassResonance);
