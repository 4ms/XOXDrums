...
struct TomInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 12> Elements{{
		...
		WhiteMomentary7mm{{to_mm<96>(39.2), to_mm<96>(309.335), Center, "pushButton", ""}},
		GateJackInput4ms{{to_mm<96>(39.2), to_mm<96>(362.802), Center, "Trigger In", ""}},
		...
		AnalogJackInput4ms{{to_mm<96>(39.2), to_mm<96>(418.269), Center, "Pitch Decay CV In", ""}},
