...
struct SnareInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 19> Elements{{
		...
		GateJackInput4ms{{to_mm<96>(47.387), to_mm<96>(309.615), Center, "Trigger In", ""}},
		...
		AnalogJackInput4ms{{to_mm<96>(47.387), to_mm<96>(363.122), Center, "Noise Color CV In", ""}},
		AnalogJackInput4ms{{to_mm<96>(111.761), to_mm<96>(363.122), Center, "Noise Decay CV In", ""}},
		...
		AnalogJackInput4ms{{to_mm<96>(176.134), to_mm<96>(418.602), Center, "Saturation CV In", ""}},
